...
const ScenarioCard: React.FC<ScenarioCardProps> = ({ scenario, onSelect }) => {
  ...
  return (
    <div
      ...
      className="group bg-white rounded-xl border border-stone-200 p-6 cursor-pointer hover:shadow-lg hover:border-orange-300 transition-all duration-300"
    >
      ...
      <h3 className="text-lg font-bold text-stone-800 mb-2 group-hover:text-orange-600 transition-colors">
        {scenario.title}
      </h3>
